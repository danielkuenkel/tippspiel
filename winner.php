...
<html lang="en">
    <head>
        <title>Tippspiel - Gewinner</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div id="navigation-line">
            <ul class="nav nav-pills nav-justified">
                ...
                <li role="presentation" id="btn-winner" class="active"><a href="#"><i class="fa fa-heart"></i> Siegertipp</a></li>
        ...
        <div class="container main-content" id="main-content">
            ...
            <div class="well text-center">
                <span id="times-up" class="hidden">Tippen oder das Ändern des Tipps für den WM-Sieger ist nicht mehr möglich! Jetzt heißt es warten, bis das Finalspiel zu Ende ist.</span>
                <span id="no-tip-submitted" class="hidden">Du hast keinen Tipp für den WM-Sieger abgegeben!</span>
                <p id="counter-time-header" class="hidden">Um deinen Tipp für den Weltmeister abzugeben oder zu ändern, hast du noch: </p>
                <span id="counter-time" class="hidden" style="font-size: 15pt; font-weight: bold"></span>
            </div>

            <div class="col-xs-6 col-sm-4 col-md-3 hidden text-center country-item" id="country-container-item">
                <img class="flag" src="" style="width: 64px; height: auto; margin-top: 0px"><br/>
                <p class="country-name"></p>
                <p class="user-tip-winner hidden"><i class="glyphicon glyphicon glyphicon-fire"></i> Dein Tipp</p>
                <button class="btn btn-success btn-submit-tip"><i class="fa fa-heart"></i> <span class="hidden-xs">Wird Weltmeister</span></button>
            </div>

            <div id="country-list" style="margin-top: 20px;"></div>
